...
function Homepage() {
  ...
  return (
    <div className={`w-screen h-screen overflow-y-hidden bg-black  sm:z-0 sm:relative sm:w-[100vw] sm:h-[100vh] sm:bg-black`}>
      <div
        className={`${
      ...
      >
        <div className="sm:flex-col sm:mx-auto flex-col mx-auto">
          <div className="sm:flex sm:items-center sm:gap-4 gap-4 flex flex-col sm:flex-row items-center">
            <div className="sm:font-semibold sm:text-lg sm:max-h-max sm:min-w-[60%] sm:max-w-[80%] sm:border-2 sm:border-purple-600 sm:mx-auto sm:text-white sm:py-8 sm:px-7 
            ...
            <div className="  sm:flex sm:items-center sm:gap-3 flex items-center  gap-3">
              <FaRegCopy
                ...
                className="hidden sm:block sm:block sm:text-3xl sm:cursor-pointer text-3xl cursor-pointer  "
              />
              {copiedText && (
...
border-2">
            Share on
            <img className="sm:h-[30px] sm:w-[30px] w-[30px] h-[30px] " src={img} alt="" />
          </button>
          {bigLike && (
            <FaHeart className="sm:text-white sm:text-9xl sm:absolute sm:animate-pulse sm:top-[40%] sm:left-[50%]" />
          )}
        </div>
      </div>
      <Likedpage
